  ...
  return (
    ...
    <Card theme="light">
      <CardBody>
        ...
        <br/>
        <h5>This was my final capstone for my Master's in Information Security. In this project I developed, from scratch, a software defined radio application for Android OS, to run replay atttacks against Family Radio Service. I ported the linux kernel module over to AOSP and then built the native service interface to communicate to the device via USB. I then connected the service to an Android application using my own developed intents.</h5>
